...
// target/debug/dtc -q /storage/Projekte/tracing_env/tracing_compiler/example_queries/count.cql -u /storage/Projekte/tracing_env/tracing_compiler/example_udfs/count.cc --root-node productpage-v1 -o example_queries/count.cc
